...
__all__ = ['DenseNet', 'densenet121_ibn_b', 'densenet169_ibn_b', 'densenet201_ibn_b', 'densenet161_ibn_b']
...
def densenet121_ibn_b(pretrained=False, **kwargs):
...
def densenet169_ibn_b(pretrained=False, **kwargs):
...
def densenet201_ibn_b(pretrained=False, **kwargs):
...
def densenet161_ibn_b(pretrained=False, **kwargs):
...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features, num_output_features,ibn=False):
...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        self.features = nn.Sequential(OrderedDict([
            ...
            ('norm0', nn.InstanceNorm2d(num_init_features, affine=True)),#nn.BatchNorm2d(num_init_features)),
        ...
        for i, num_layers in enumerate(block_config):
            ...
            if i != len(block_config) - 1:
                trans = _Transition(num_input_features=num_features, num_output_features=num_features // 2,ibn=ibn)
